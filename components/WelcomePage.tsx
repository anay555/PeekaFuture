                    ...
                    <div className="bento-grid">
                        ...
                        />
                         <BentoItem 
                            ...
                            description={
                                <>
                                    <p>Get a real-time pulse on the job market for your chosen career.</p>
                                    <ul className="mt-4 space-y-2 text-sm">
                                        <li className="flex items-start gap-2"><CheckIcon className="w-4 h-4 text-green-500 mt-1 flex-shrink-0" /><span><strong>Up-to-Date Salary Data:</strong> See current salary ranges for entry-level roles.</span></li>
                                        <li className="flex items-start gap-2"><CheckIcon className="w-4 h-4 text-green-500 mt-1 flex-shrink-0" /><span><strong>Demand & Locations:</strong> Understand job demand and top hiring cities in India.</span></li>
                                        <li className="flex items-start gap-2"><CheckIcon className="w-4 h-4 text-green-500 mt-1 flex-shrink-0" /><span><strong>Google Search Powered:</strong> Insights are grounded in live web data for accuracy.</span></li>
                                    </ul>
                                </>
                            }
                        />
